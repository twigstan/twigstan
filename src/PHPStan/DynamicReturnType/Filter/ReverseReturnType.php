...
final readonly class ReverseReturnType implements DynamicStaticMethodReturnTypeExtension
{
    ...
    {
        return $methodReflection->getName() === 'reverse';
    }
    ...
    public function getTypeFromStaticMethodCall(
        ...
        return $scope->getType(new FuncCall(
            new Name('array_reverse'),
            array_slice($methodCall->args, 1),
        ));
    }
}
